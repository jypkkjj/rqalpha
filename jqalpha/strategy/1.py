...
def z_test():
    ...
    prices1 = np.array(get_bars(g.security1, g.test_days, '1d', ['close']).close)
    prices2 = np.array(get_bars(g.security2, g.test_days, '1d', ['close']).close)
